...
<div class="container my-4">
    <div class="row">
        <div class="col table-responsive">
            <h3 class="text-primary mb-3">Delivered orders</h3>
